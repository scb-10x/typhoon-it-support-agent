...
class TestRealUserAPIScenarios:
    ...
    def test_assign_ticket_to_agent(self):
        ...
        response = client.post(
            f"/tickets/{ticket_id}/assign", json={"assignee_id": "agent_3"}
        )
    ...
    def test_add_tags_to_ticket(self):
        ...
        # Create ticket
        create_response = client.post(
            "/tickets", json={"subject": "Printer jam", "description": "Paper stuck"}
        )
        ticket_id = create_response.json()["ticket"]["id"]
    ...
    def test_set_ticket_category(self):
        ...
        # Set category
        response = client.post(
            f"/tickets/{ticket_id}/category", json={"category": "software"}
        )
    ...
    def test_advanced_search(self):
        ...
        response = client.get(
            "/tickets/search/advanced?query=VPN&priority=high&status=open&category=vpn"
        )
...
class TestEdgeCasesAPI:
    ...
    def test_update_nonexistent_ticket(self):
        ...
        response = client.patch("/tickets/9999", json={"status": "open"})
        assert response.status_code == 404
    ...
    def test_assign_invalid_agent(self):
        ...
        response = client.post(
            "/tickets", json={"subject": "Test", "description": "Test"}
        )
        ticket_id = response.json()["ticket"]["id"]

        response = client.post(
            f"/tickets/{ticket_id}/assign", json={"assignee_id": "invalid_agent"}
        )
    ...
    def test_set_invalid_status(self):
        ...
        response = client.patch(
            f"/tickets/{ticket_id}", json={"status": "super_duper_closed"}
        )
        assert response.status_code == 400
    ...
    def test_set_invalid_priority(self):
        ...
        response = client.patch(
            f"/tickets/{ticket_id}", json={"priority": "extremely_urgent"}
        )
        assert response.status_code == 400
    ...
    def test_set_invalid_category(self):
        ...
        response = client.post(
            f"/tickets/{ticket_id}/category", json={"category": "invalid_category"}
        )
        assert response.status_code == 400
    ...
    def test_bulk_update_empty_list(self):
        ...
        response = client.post(
            "/tickets/bulk/update", json={"ticket_ids": [], "status": "open"}
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_bulk_update_partial_failure(self):
        ...
        response = client.post(
            "/tickets/bulk/update",
            json={"ticket_ids": [valid_id, 9999, 8888], "status": "open"},
        )
    ...
    def test_very_long_subject(self):
        ...
        response = client.post(
            "/tickets",
            json={"subject": long_subject, "description": "Test description"},
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_concurrent_updates_same_ticket(self):
        ...
        responses.append(
            client.post(f"/tickets/{ticket_id}/assign", json={"assignee_id": "agent_1"})
        )
        responses.append(
            client.patch(f"/tickets/{ticket_id}", json={"priority": "high"})
        )
        responses.append(
            client.post(f"/tickets/{ticket_id}/tags", json={"tags": ["urgent"]})
        )
...
class TestIntegrationAPI:
    ...
    def test_full_ticket_lifecycle_via_api(self):
        ...
        assign_response = client.post(
            f"/tickets/{ticket_id}/assign", json={"assignee_id": "agent_2"}
        )
        assert assign_response.status_code == 200

        # 3. Set category
        category_response = client.post(
            f"/tickets/{ticket_id}/category", json={"category": "account_access"}
        )
        assert category_response.status_code == 200

        # 4. Add tags
        tags_response = client.post(
            f"/tickets/{ticket_id}/tags", json={"tags": ["permissions", "file-share"]}
        )
        ...
        status_response = client.patch(
            f"/tickets/{ticket_id}",
            json={"status": "open", "comment": "Investigating permissions issue"},
        )
    ...
    def test_multi_ticket_incident_via_api(self):
        ...
        bulk_response = client.post(
            "/tickets/bulk/update",
            json={"ticket_ids": ticket_ids, "assignee_id": "agent_3"},
        )
        ...
        bulk_resolve = client.post(
            "/tickets/bulk/update", json={"ticket_ids": ticket_ids, "status": "solved"}
        )

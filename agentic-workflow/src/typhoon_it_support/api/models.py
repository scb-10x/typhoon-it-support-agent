...
class TicketCreateRequest(BaseModel):
    ...
    priority: str = Field(
        "normal", description="Ticket priority (low, normal, high, urgent)"
    )
    requester_email: Optional[str] = Field(
        None, description="Email of the person reporting the issue"
    )
    requester_name: Optional[str] = Field(
        None, description="Name of the person reporting the issue"
    )
...
class BulkUpdateRequest(BaseModel):
    ...
    assignee_id: Optional[str] = Field(
        None, description="Agent ID to assign tickets to"
    )
